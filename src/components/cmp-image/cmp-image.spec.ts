...
describe("cmp-image", () => {
  ...
  describe("getImage", () => {
    ...
    it("returns the image with the default image directory", () => {
      const component = new CmpImage();
      expect(component.getImg("photo.jpg")).toEqual(
        component.imgDirectory + "photo.jpg"
      );
    });

    it("returns the image with a custom image directory", () => {
      const component = new CmpImage();
      component.imgDirectory = "assets/icon/";
      expect(component.getImg("photo.png")).toEqual("assets/icon/photo.png");
    });
  });
});
